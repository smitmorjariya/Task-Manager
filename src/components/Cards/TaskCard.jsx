...
const TaskCard = ({
    title, description, priority, status, progress, createdAt, dueDate, assignedTo, attachmentsCount, completedTodoCount, todoChecklist, onClick
}) => {
                ...
                <div className="flex items-center justify-between mt-3">
                    ...
                    {attachmentsCount > 0 && (
                        <div className="flex items-center gap-2 bg-blue-50 px-2.5 py-1.5 rounded-lg ">
                            ...
                            <span className="text-xs text-gray-900">{attachmentsCount}</span>
                        </div>
                    )}
                </div>
            </div>
